...
total_delta = sum((pos.delta * 100 if pos.isOption else pos.delta) for pos in ticker.positions)
total_gamma = sum((pos.gamma * 100 if pos.isOption else pos.gamma) for pos in ticker.positions)
